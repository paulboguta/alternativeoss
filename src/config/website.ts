...
export const metadata: Metadata = {
  ...
  description: "Discover the best open source alternatives to popular software. A comprehensive directory of open source software alternatives for all your needs.",
  keywords: [
    "open source",
