  ...
  return (
    <>
      <p className="max-w-[550px] text-lg leading-tight font-light text-white">
        Find and compare the best open source alternatives to popular software tools. Get weekly
        recommendations in your inbox.
      </p>
      <form onSubmit={handleSubmit} className="mt-3 flex w-full max-w-sm space-x-2">
        <Input
          type="email"
          ...
          disabled={isPending}
        />
        <Button type="submit" className="h-9 cursor-pointer" disabled={isPending}>
