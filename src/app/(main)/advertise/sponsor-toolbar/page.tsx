...
export default function SponsorToolbarDemoPage() {
  return (
    <div className="px-4 md:px-8">
      <section className="mx-auto flex flex-col gap-3 py-8 md:py-12 md:pb-8 lg:py-16">
        <div className="space-y-2">
          ...
          <h1 className="text-2xl font-bold tracking-tight">Toolbar Sponsor Demo</h1>
        </div>
        <p className="text-muted-foreground text-sm">
          This is how your sponsor badge will appear in the site toolbar on every page.
        </p>
      </section>
        ...
        <div className="flex flex-col gap-8">
          ...
          <div>
            ...
            <div className="bg-muted/30 relative aspect-video w-full overflow-hidden rounded-lg border">
              <OptimizedImage
                src={`${env.NEXT_PUBLIC_CDN_URL}/assets/ad-spot-3.webp`}
                alt="Ad Spot 3 placement example"
                fill
