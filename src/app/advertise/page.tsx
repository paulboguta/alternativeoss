            ...
            <section className="mx-auto flex flex-col gap-3 py-8 md:py-12 md:pb-8 lg:py-24 lg:pb-10">
              ...
              <div className="border-primary/30 mt-6 max-w-[650px] space-y-1 border-l-2 py-2 pl-4">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  All open source projects shown are included based on usefulness, activity, but
                  never payment. The only way we monetize is through clearly marked advertisements
                  and sponsors, keeping our recommendations authentic and trustworthy. Moreover, the
                  advertisements are vetted so they are related to tech and are actually useful.
                </p>
              </div>
            </section>
